P6Level = Class{__includes = BaseState}

function P6Level:render()
    push:apply('start')
    local wb = gTextures['p6Background']:getWidth()
    local hb = gTextures['p6Background']:getHeight()
    love.graphics.draw(gTextures['p6Background'],0,0,0,VIRTUAL_WIDTH / (wb - 1), VIRTUAL_HEIGHT / (hb - 1))
    love.drawBack()
...
function P6Level:mousePressed(x,y)
