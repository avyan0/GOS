...
function Button:setFont(font)
    assert(type(font) == 'string' or type(font) == 'userdata', 'Argument "Font" in Button:setFont must be of type string or Font')
    if type(font) == 'string' then
        self.font = lg.newFont(font, 18)  -- Modify the font size (18) as needed
        self.text = lg.newText(self.font, self.label)
    elseif type(font) == 'userdata' then
        self.font = font
        self.text = lg.newText(self.font, self.label)
    end
end
