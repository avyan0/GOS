...
function PauseState:render()
	...
	local h1 = gTextures['mouse']:getHeight()
	love.graphics.draw(gTextures['mouse'],85,300, 0,20/w1,30/h1)
	love.graphics.draw(gTextures['mouse'],105,300, 0,20/w1,30/h1)
	love.graphics.draw(gTextures['mouse'],135,300, 0,20/w1,30/h1)
	love.graphics.draw(gTextures['mouse'],165,300, 0,20/w1,30/h1)
	love.graphics.draw(gTextures['mouse'],195,300, 0,20/w1,30/h1)
	local w2 = gTextures['keyboard']:getWidth()
	local h2 = gTextures['keyboard']:getHeight()
	love.graphics.draw(gTextures['keyboard'],75,330, 0,20/w2,30/h2)
	love.graphics.draw(gTextures['keyboard'],105,330, 0,20/w2,30/h2)
	love.graphics.draw(gTextures['keyboard'],135,330, 0,20/w2,30/h2)
	love.graphics.draw(gTextures['keyboard'],165,330, 0,20/w2,30/h2)
	love.graphics.draw(gTextures['keyboard'],195,330, 0,20/w2,30/h2)
