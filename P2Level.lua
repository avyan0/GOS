P2Level = Class{__includes = BaseState}

function P2Level:render()
    push:apply('start')
    local wb = gTextures['p2Background']:getWidth()
    local hb = gTextures['p2Background']:getHeight()
    love.graphics.draw(gTextures['p2Background'],0,0,0,VIRTUAL_WIDTH / (wb - 1), VIRTUAL_HEIGHT / (hb - 1))
...
function P2Level:mousePressed(x,y)
